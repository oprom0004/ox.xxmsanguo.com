    ...
    <div className="min-h-screen bg-[#0b0e11] text-zinc-300 font-sans selection:bg-yellow-500 selection:text-black antialiased">
      ...
      <MobileStickyFooter>
        <button
          type="button"
          data-cta="true"
          className="w-full bg-blue-600 hover:bg-blue-500 text-white font-extrabold shadow-lg shadow-amber-500/20 py-3.5 rounded-xl flex items-center justify-center transition-colors shadow-lg shadow-white/5 cursor-pointer select-none"
        >
