...
export const SEO_KEYWORDS_MAP_HANT: Record<string, SeoPageData> = {
  "home": {
    ...
    "heroTitle": "歐意 OKX 多端直连通道及客户端客户端下载",
  ...
  "xiazai": {
    "route": "xiazai",
    "tabLabel": "下载大厅",
    "title": "歐意OKX全平台客户端客户端下载总站：Windows/Mac/Android/iOS一键直达",
  ...
  "yiou-fangdiaoyu-anquanma-yanzheng-shezhi-shizhan-zhinan": {
    ...
    "detailedSteps": [
      ...
      },
      {
        "step": 3,
        "title": "使用正版驗證中心查询",
        "desc": "遇任何可疑网址或自称正版人员，直接在官网【正版渠道驗證中心】输入查询核实真伪。"
      }
    ],
    "targetedFaq": [
      {
        "q": "收到自称‘OKX客服’提示‘账户涉及黑钱需提币到安全地址审查’的短信怎么辨别？",
        "a": "100% 为诈骗！OKX 正版工作人员绝不会以任何理由要求用户向任何所谓‘安全账户’转账。凡是收到此类短信，请直接在官网【正版渠道驗證中心】输入发送号码或网址查询真伪。"
      },
      {
